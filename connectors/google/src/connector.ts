...
export const googleConnectorModule: ConnectorModule = {
  definition: {
    id: 'google',
    ...
    serviceIcons: {
      ...
      googledrive: { type: 'simpleIcons', slug: 'googledrive' },
      googlecalendar: { type: 'simpleIcons', slug: 'googlecalendar' },
      googledocs: { type: 'simpleIcons', slug: 'googledocs' },
    },
    authType: 'oauth2',
    authConfig: {
