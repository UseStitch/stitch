...
CREATE TABLE `__new_model_visibility` (
	`provider_id` text NOT NULL,
	`model_id` text NOT NULL,
	`visibility` text NOT NULL,
	`updated_at` integer NOT NULL,
	FOREIGN KEY (`provider_id`) REFERENCES `provider_config`(`provider_id`) ON UPDATE no action ON DELETE cascade
);
--> statement-breakpoint
INSERT INTO `__new_model_visibility`("provider_id", "model_id", "visibility", "updated_at") SELECT "provider_id", "model_id", "visibility", "updated_at" FROM `model_visibility`;--> statement-breakpoint
DROP TABLE `model_visibility`;--> statement-breakpoint
ALTER TABLE `__new_model_visibility` RENAME TO `model_visibility`;--> statement-breakpoint
