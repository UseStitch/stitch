...
import { macosToolProvider, macosToolset } from '@/tools/providers/macos-provider.js';
...
const providers: ToolProvider[] = [meetingsToolProvider, browserToolProvider, macosToolProvider];
...
/**
 * Register all built-in provider toolsets (browser, meetings, macos) with the global registry.
 * Call once at startup.
 */
export function registerProviderToolsets(): void {
  registerToolset(browserToolset);
  registerToolset(macosToolset);
