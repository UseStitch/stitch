...
export type PruneProtectOverride = { protectTokens: number; reason: string };
...
export function getToolPruneProtectOverrides(messages: PrunePolicyMessage[]): Map<string, PruneProtectOverride> {
