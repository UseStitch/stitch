...
const driveWriteSchema = z.object({
  ...
  mimeType: z.string().optional().default('text/plain').describe('MIME type of the file (default: text/plain). Use "text/markdown" for Markdown files.'),
...
export const DRIVE_TOOL_SUMMARIES = [
  ...
  { name: 'drive_write', description: 'Create a new text or Markdown file in Google Drive (requires write access)' },
];
