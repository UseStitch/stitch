...
export const SETTINGS_SCHEMAS: Record<SettingsKey, z.ZodType> = {
  ...
  'recordings.mode': z.enum(['mic', 'speaker', 'dual']),
  ...
  'recordings.quality': z.enum(['speech', 'high']),
...
export const SETTINGS_DEFAULTS: SettingDefault[] = [
  ...
  },
  {
    key: 'recordings.mode',
    value: 'dual',
    description: 'Audio capture mode: mic (microphone only), speaker (system audio only), or dual (both).',
  },
  {
  ...
  {
    key: 'recordings.quality',
    value: 'speech',
    description: 'Audio quality preset. speech: 16kHz mono (optimized for voice), high: 48kHz mono (higher fidelity).',
  },
  {
