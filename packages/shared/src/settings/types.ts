...
export const SETTINGS_DEFAULTS: SettingDefault[] = [
  ...
  { key: 'model.compaction', value: '', description: 'Preferred model for conversation compaction summaries.' },
  { key: 'model.title', value: '', description: 'Preferred model for generating session titles.' },
  { key: 'compaction.auto', value: 'true', description: 'Enable automatic context compaction when token usage reaches the configured threshold.' },
  { key: 'compaction.prune', value: 'true', description: 'Prune old tool outputs before generating a compaction summary.' },
  { key: 'compaction.reserved', value: '20000', description: 'Reserved token headroom used when deciding whether to compact.' },
