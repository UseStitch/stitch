// Vendored from https://github.com/fastrepl/hyprnote (crates/audio-sync/src/probe.rs), MIT licensed.
...
impl SyncProbe {
  ...
  fn is_lag_outlier(&self, lag_samples: isize, stable_lag_samples: isize) -> bool {
    (lag_samples - stable_lag_samples).unsigned_abs() > self.tuning.lock_outlier_tolerance_samples
  }
