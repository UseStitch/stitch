      ...
      {eligibleAccounts.map((account) => (
        <div
          ...
          <Button
            variant="outline"
            size="sm"
            className="ml-4 h-7 shrink-0 rounded-md border-border/60 bg-transparent px-2.5 text-xs font-semibold text-foreground/90 transition-colors hover:bg-muted/50"
