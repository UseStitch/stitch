...
const statusStyles = {
  in_progress: { dot: 'bg-primary', content: '' },
  completed: { dot: 'bg-success', content: 'text-muted-foreground line-through' },
  cancelled: { dot: 'bg-muted-foreground/40', content: 'text-muted-foreground' },
  pending: { dot: 'bg-warning', content: '' },
