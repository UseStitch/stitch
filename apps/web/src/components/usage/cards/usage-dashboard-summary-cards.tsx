...
type UsageDashboardSummaryCardsProps = { rangeLabel: string; usageData: UsageDashboardResponse | undefined };

export function UsageDashboardSummaryCards({ rangeLabel, usageData }: UsageDashboardSummaryCardsProps) {
